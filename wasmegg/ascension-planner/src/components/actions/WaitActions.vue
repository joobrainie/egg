<template>
  <div class="space-y-4">
    ...
    <div
      v-if="!actionsStore.effectiveSnapshot.activeSales.research"
      class="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md"
    >
      <button
        class="w-full px-5 py-4 bg-slate-50/50 flex justify-between items-center hover:bg-white transition-colors group"
      ...
      >
        <div class="flex items-center gap-3">
          <div
            class="w-8 h-8 rounded-xl bg-purple-100 border border-purple-200 shadow-sm flex items-center justify-center p-1.5 group-hover:scale-110 transition-transform"
          >
